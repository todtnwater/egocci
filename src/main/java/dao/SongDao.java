...
public class SongDao {
    ...
    public ArrayList<SongDto> getSongsByAlbum(String albumType) {
        ...
        try {
            ...
            String sql = "SELECT s.*, a.album_title, a.album_type, a.album_number " +
                        ...
                        "ORDER BY a.display_order ASC, s.track_number ASC";
    ...
    public int saveSong(SongDto song) {
        ...
        try {
            con = DBConnection.getConnection();
            String sql = "INSERT INTO songs (album_id, song_title, artist_name, genre, " +
                        "lyrics, track_number, duration, is_title_track, song_cover_image, display_order) " +
                        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            ps.setInt(6, song.getTrack_number());
            ps.setString(7, song.getDuration());
            ps.setBoolean(8, song.getIs_title_track());
            ps.setString(9, song.getSong_cover_image());
            ps.setInt(10, song.getDisplay_order());
    ...
    public boolean updateSong(SongDto song) {
        try {
            ...
            String sql = "UPDATE songs " +
                        "SET song_title = ?, artist_name = ?, genre = ?, lyrics = ?, song_cover_image = ? " +
                        "WHERE song_id = ? AND is_active = true";
            
            ps = con.prepareStatement(sql);
            ps.setString(1, song.getSong_title());
            ps.setString(2, song.getArtist_name());
            ps.setString(3, song.getGenre());
            ps.setString(4, song.getLyrics());
            ps.setString(5, song.getSong_cover_image());
            ps.setInt(6, song.getSong_id());
