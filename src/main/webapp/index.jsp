...
감상해주셔서 감사합니다.</textarea>
                ...
                <div class="index-icon-container">
                   <a href="Song?t_gubun=list" class="index-icon" title="곡 목록보기">
            ...
            <div class="content-mid1">
                <a href="Scheduled">
                    <%
                        ...
                        if (latestScheduled != null && latestScheduled.getPoster_image() != null && !latestScheduled.getPoster_image().isEmpty()) {
